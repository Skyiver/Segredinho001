...
class TestSchoolAPI(unittest.TestCase):
    ...
    def reset_server(self):
        "Reseta os dados da API para o estado inicial."
    ...
    def test_alunos_get_por_id(self):
        ...
        r1 = requests.post(f"{BASE_URL}/alunos", json=aluno)
    ...
    def test_alunos_put_atualiza_aluno(self):
        ...
        r2 = requests.put(f"{BASE_URL}/alunos/103", json=novo_nome)
        self.assertEqual(r2.status_code, 200)
        data = r2.json()
    ...
    def test_alunos_delete_remove_aluno(self):
        ...
        r1 = requests.post(f"{BASE_URL}/alunos", json=aluno)
        self.assertEqual(r1.status_code, 200)
        r2 = requests.delete(f"{BASE_URL}/alunos/104")
    ...
    def test_alunos_post_id_duplicado(self):
        ...
        r1 = requests.post(f"{BASE_URL}/alunos", json=aluno)
        self.assertEqual(r1.status_code, 200)
        r2 = requests.post(f"{BASE_URL}/alunos", json=aluno)
    ...
    def test_alunos_put_sem_nome(self):
        ...
        r1 = requests.post(f"{BASE_URL}/alunos", json=aluno)
        self.assertEqual(r1.status_code, 200)
        r2 = requests.put(f"{BASE_URL}/alunos/106", json={"id": 106})
        self.assertEqual(r2.status_code, 400)
        data = r2.json()
    ...
    def test_professores_get_por_id(self):
        ...
        r1 = requests.post(f"{BASE_URL}/professores", json=professor)
        self.assertEqual(r1.status_code, 200)
    ...
    def test_professores_put_atualiza_professor(self):
        ...
        r2 = requests.put(f"{BASE_URL}/professores/203", json=novo)
        self.assertEqual(r2.status_code, 200)
        data = r2.json()
    ...
    def test_professores_delete_remove_professor(self):
        ...
        r1 = requests.post(f"{BASE_URL}/professores", json=professor)
        self.assertEqual(r1.status_code, 200)
        r2 = requests.delete(f"{BASE_URL}/professores/204")
        self.assertIn(r2.status_code, [200, 204])
    ...
    def test_professores_post_id_duplicado(self):
        ...
        r1 = requests.post(f"{BASE_URL}/professores", json=professor)
        self.assertEqual(r1.status_code, 200)
        r2 = requests.post(f"{BASE_URL}/professores", json=professor)
        self.assertEqual(r2.status_code, 400)
        data = r2.json()
        self.assertEqual(data.get("erro"), "id ja utilizada")
    ...
    def test_professores_post_sem_nome(self):
        self.reset_server()
        r = requests.post(f"{BASE_URL}/professores", json={"id": 206})
    ...
    def test_turmas_post_cria_turma(self):
        self.reset_server()
        # Precisa sempre criar professor antes
        professor = {"nome": "Prof. Teste", "id": 201}
        rp = requests.post(f"{BASE_URL}/professores", json=professor)
    ...
    def test_turmas_get_por_id(self):
        ...
        rt = requests.post(f"{BASE_URL}/turmas", json=turma)
    ...
    def test_turmas_put_atualiza_turma(self):
        ...
        r = requests.put(f"{BASE_URL}/turmas/303", json=novo)
        self.assertEqual(r.status_code, 200)
        data = r.json()
    ...
    def test_turmas_delete_remove_turma(self):
        ...
        rt = requests.post(f"{BASE_URL}/turmas", json=turma)
        self.assertEqual(rt.status_code, 200)
        rd = requests.delete(f"{BASE_URL}/turmas/304")
    ...
    def test_turmas_post_sem_nome(self):
        ...
        rp = requests.post(f"{BASE_URL}/professores", json=professor)
        self.assertEqual(rp.status_code, 200)
        r = requests.post(f"{BASE_URL}/turmas", json={"id": 305, "professor_id": 205})
        self.assertEqual(r.status_code, 400)
        data = r.json()
